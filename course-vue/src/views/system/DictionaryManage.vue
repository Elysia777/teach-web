  ...
  <div class="base_form">
    ...
    <div class="base_query_oneLine">
      <div class="query_left">
        ...
        <button class="commButton" style="margin-left: 5px" @click="addItem">添加数据项</button>
        <button class="commButton" style="margin-left: 5px" @click="editItem">修改</button>
        <button class="commButton" style="margin-left: 5px" @click="deleteItem">删除</button>
      </div>
    </div>
...
import { getDictionaryTreeNodeList, dictionarySave, dictionaryDelete } from '@/services/systemServ'
