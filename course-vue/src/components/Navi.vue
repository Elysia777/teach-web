<template xmlns="">
  <div style="height: 100%">
    ...
    <div
      style="height: 100%"
      v-if="userInfo.username && userInfo.username.length > 0 && systemConfig.showLeftMeun"
    >
        ...
        <el-header height="40" class="topHeader">
            ...
            <div class="block1 justify-between">
              ...
              <div class="flex-row">
                ...
                <div class="section3 flex-col justify-between">
                  ...
                  <span class="info"
                    >{{ userInfo.perName }}({{ userInfo.username }}) {{ currentTime }}</span
                  >
                </div>
          ...
          >
            <template v-for="(v, i) in systemConfig.naviList" :key="i">
              <el-menu-item :index="'/' + v.name" @click="getSecondList(v.id)">{{
                v.title
              }}</el-menu-item>
            </template>
          </el-menu>
                  ...
                  <template v-if="v.sList.length > 0">
                    <el-submenu :index="i.toString()">
                      ...
                      <el-menu-item-group v-for="(item, j) in v.sList" :key="j">
                        <el-menu-item :index="'/' + item.name" @click="routerName(item.name)">{{
                          item.title
                        }}</el-menu-item>
                      </el-menu-item-group>
                    </el-submenu>
