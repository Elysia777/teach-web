...
export default defineComponent({
  ...
  methods: {
    ...
    drawEcharts() {
      //绘制用户活跃图表
      if (onlineUserChart != null && onlineUserChart != '' && onlineUserChart != undefined) {
        onlineUserChart.dispose() //解决echarts dom已经加载的报错
      }
      if (userTypeChart != null && userTypeChart != '' && userTypeChart != undefined) {
        userTypeChart.dispose() //解决echarts dom已经加载的报错
      }
      if (requestChart != null && requestChart != '' && requestChart != undefined) {
        requestChart.dispose() //解决echarts dom已经加载的报错
      }
      if (operateChart != null && operateChart != '' && operateChart != undefined) {
        operateChart.dispose() //解决echarts dom已经加载的报错
      }
      onlineUserChart = echart.init(document.getElementById('onlineUserChart') as any)
      ...
      //      绘制用户分类图表
      userTypeChart = echart.init(document.getElementById('userTypeChart') as any)
      ...
      //绘制请求图表
      requestChart = echart.init(document.getElementById('requestChart') as any)
      ...
      // 绘制修改数据图表
      operateChart = echart.init(document.getElementById('operateChart') as any)
