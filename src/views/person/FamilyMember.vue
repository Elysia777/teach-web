  ...
  <div class="base_form">
    ...
    <div class="base_query_oneLine">
      <div class="query_left">
        <el-button class="commButton" size="mini" @click="addRow()">添加一行</el-button>
      </div>
    </div>
    <!-- 数据表区 -->
    <div class="table-content">
      ...
      >
        ...
        <el-table-column label="操作" width="150" color="black" align="center">
          <template v-slot="scope">
            <el-button class="commButton" size="mini" @click="saveItem(scope.$index)"
              >保存</el-button
            >
            <el-button class="commButton" size="mini" @click="deleteItem(scope.$index)"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
import { getFamilyMemberList, familyMemberSave, familyMemberDelete } from '@/services/personServ'
