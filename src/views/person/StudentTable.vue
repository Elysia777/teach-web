  ...
  <div class="base_form">
    ...
    <div class="base_query_oneLine" style="width: 97%">
      ...
      <div class="query_left">
        <el-button class="commButton" size="mini" @click="addItem()">添加</el-button>
      </div>
      <!-- 右边查询组 -->
      <div class="query_right">
        <el-input v-model="numName">学号或姓名</el-input>
        <el-button class="commButton" size="small" @click="doQuery()">查询</el-button>
        <el-button class="commButton" size="small" @click="doExport()">导出</el-button>
      </div>
    </div>
    ...
    <div class="table-content">
      ...
      >
        ...
        <el-table-column label="操作" color="black" align="center" width="260">
          <template v-slot="scope">
            <el-button class="commButton" size="mini" @click="editItem(scope.row.studentId)"
              >基本信息</el-button
            >
            <el-button class="commButton" size="mini" @click="familyMember(scope.row.studentId)"
              >家庭成员</el-button
            >
            <el-button class="commButton" size="mini" @click="deleteItem(scope.row.studentId)"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
export default defineComponent({
  ...
  methods: {
    ...
    // 获取分页数据
    async getDataPage() {
      const res = await getStudentPageData(this.numName, this.pagination.currentPage)
    ...
    // 导出学生信息
    async doExport() {
      const res = await downloadPost('/api/student/getStudentListExcl', '学生.xlsx', {
